...
export const DiaryDocumentCard: React.FC<DiaryDocumentCardProps> = ({ memory, onClick }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-[#1c1917] p-4 sm:p-5 rounded-md border border-[#3b322b] shadow-[0_25px_60px_rgba(0,0,0,0.9)] ring-1 ring-amber-900/30">
        ...
        <div className="absolute -top-3 right-8 w-4 h-9 bg-[#8b2626] shadow-md border-x border-[#5c1a1a] rounded-b-xs pointer-events-none" />

        {/* Top Header Badge */}
        <div className="flex items-center justify-between pb-3 mb-3 border-b border-amber-900/30">
          <div className="flex items-center gap-1.5 text-[#d4af37] text-[11px] font-mono-tech tracking-widest uppercase">
            <Lock className="w-3 h-3 text-[#d4af37]/70" />
            <span>CONFIDENTIAL ARCHIVE</span>
          </div>
          <div className="flex items-center gap-1 text-[11px] font-mono-tech text-white/50">
        ...
        <div className="relative aspect-[3/4] w-full overflow-hidden bg-[#0d0e12] rounded-xs border border-white/10 shadow-inner">
          ...
          <div className="absolute bottom-0 inset-x-0 p-3.5 bg-gradient-to-t from-black via-black/90 to-transparent">
          ...
          >
            <div className="p-3.5 rounded-full bg-black/80 border border-[#d4af37]/70 text-[#d4af37] shadow-2xl">
              <BookOpen className="w-6 h-6" />
            </div>
            <span className="text-xs font-mono-tech tracking-widest uppercase text-white bg-black/80 px-3 py-1 rounded-full border border-white/10">
